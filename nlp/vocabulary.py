...
class Vocabulary():
    ...
    def initialize_and_save_vocab(self, document_gen, path, **kwargs):
        """Initializes vocabulary from the sentences generated by
        document_gen. 
        Additional parameters:
        ngrams: controls the n in n-grams to decide which
        phrases to combine. Please note that this is a statistical
        combination of n-grams.
        ngram-rules: regex rules to apply to combine unigrams to ngrams.
        """
