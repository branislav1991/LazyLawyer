import argparse
from lazylawyer.scripts.crawl_cases_docs_curia import crawl_cases_docs_curia
from lazylawyer.scripts.download_docs_curia import download_docs_curia
from lazylawyer.scripts.extract_content_curia import extract_content_curia
